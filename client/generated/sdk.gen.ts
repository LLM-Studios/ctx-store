 ...
 */
export const createMessages = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateMessagesData, ThrowOnError>) => {
 ...
 */
export const getMessage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetMessageData, ThrowOnError>) => {
 ...
 */
export const updateMessage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateMessageData, ThrowOnError>) => {
 ...
 */
export const deleteMessage = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteMessageData, ThrowOnError>) => {
 ...
 */
export const getThread = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetThreadData, ThrowOnError>) => {
 ...
 */
export const updateThread = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<UpdateThreadData, ThrowOnError>) => {
 ...
 */
export const deleteThread = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<DeleteThreadData, ThrowOnError>) => {
 ...
 */
export const listThreads = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<ListThreadsData, ThrowOnError>) => {
 ...
 */
export const createThread = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<CreateThreadData, ThrowOnError>) => {
